...
def gpu_brand_socket(full_name):
    ...
    if 'RTX' in name_upper or 'GTX' in name_upper:
        chip_prod = 'NVIDIA'
    elif 'RADEON' in name_upper or 'RX' in name_upper:
        chip_prod = 'AMD'
    ...
    if '5090' in name_upper: tdp = 600
    elif '5080' in name_upper: tdp = 400
    elif '5070 TI' in name_upper: tdp = 300
    elif '5070' in name_upper: tdp = 250
    elif '5060 TI' in name_upper: tdp = 175
    elif '5060' in name_upper: tdp = 145
    elif '5050' in name_upper: tdp = 130
    elif '4090' in name_upper: tdp = 450
    elif '4080' in name_upper: tdp = 320
    elif '4070 TI' in name_upper: tdp = 285
    elif '4070' in name_upper: tdp = 200
    elif '4060 TI' in name_upper: tdp = 160
    elif '4060' in name_upper: tdp = 115
    elif '3060 TI' in name_upper: tdp = 200
    elif '3060' in name_upper: tdp = 170
    elif '3050' in name_upper: tdp = 130
    elif '9900 XTX' in name_upper: tdp = 400
    elif '9900 XT' in name_upper: tdp = 350
    elif '9070 XT' in name_upper: tdp = 304
    elif '9070 ' in name_upper: tdp = 220
    elif '9060 XT' in name_upper: tdp = 160
    elif '9060' in name_upper: tdp = 132
    elif '8900 XTX' in name_upper: tdp = 350
    elif '8800 XT' in name_upper: tdp = 260
    elif '8700 XT' in name_upper: tdp = 220
    elif '8600' in name_upper: tdp = 150
    elif '7900 XTX' in name_upper: tdp = 355
    elif '7900 XT' in name_upper: tdp = 315
    elif '7900 GRE' in name_upper: tdp = 260
    elif '7800 XT' in name_upper: tdp = 263
    elif '7700 XT' in name_upper: tdp = 245
    elif '7600' in name_upper: tdp = 165
    elif '6700' in name_upper: tdp = 230
    elif '6600' in name_upper: tdp = 132
...
def save_items_db(items):
    try:
        ...
        with connection.cursor() as cur:
            for item in items:
                sql_string = '''
                                INSERT IGNORE INTO gpu (brand_gpu, name_gpu, chip_prod, tdp, price_gpu, review_url, image_url) 
                                VALUES (%s, %s, %s, %s, %s, %s, %s)
                            '''
                cur.execute(sql_string, (
                    item['brand_gpu'], item['name'], item['chip_prod'],
