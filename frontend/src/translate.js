export const messages = {
  ru: {
    ...
    builder: {
      ...
      filters: { allBrands: 'Все бренды', minPrice: 'Мин. ₴', maxPrice: 'Макс. ₴', minWatt: 'Мин. W' },
      placeholders: {
  ...
  uk: {
    ...
    builder: {
      ...
      filters: { allBrands: 'Всі бренди', minPrice: 'Мін. ₴', maxPrice: 'Макс. ₴', minWatt: 'Мін. W' },
      placeholders: {
  ...
  en: {
    ...
    builder: {
      ...
      filters: { allBrands: 'All brands', minPrice: 'Min ₴', maxPrice: 'Max ₴', minWatt: 'Min W' },
      placeholders: {
